...
pdf.cell(0, 4.4, "Berlin, Germany · rohit.modh1602@gmail.com · rohit.modh.workers.dev")
pdf.ln(4.6)
...
for job in EXPERIENCE:
    pdf.set_font("vera", "B", 9.6)
    pdf.set_text_color(15)
    pdf.multi_cell(0, 4.8, job["role"], new_x="LMARGIN", new_y="NEXT")
    pdf.set_font("vera", "I", 8.2)
